...
entry:
  ...
  call void @Microsoft__Quantum__OracleGenerator___db80fb546e9242059ab5fcd88d8543b5_InitOracleGeneratorFor__body(%Callable* %0)
...
header__3:                                        ; preds = %exiting__3, %body__2
  %26 = phi i64 [ 0, %body__2 ], [ %58, %exiting__3 ]
...
continue__3:                                      ; preds = %then0__3, %continue__2
  %30 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body(%Qubit* %a)
  %r1 = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %30)
  %31 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body(%Qubit* %b)
  %r2 = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %31)
  %32 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body(%Qubit* %c)
  %r3 = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %32)
  %33 = or i1 %r1, %r2
...
condContinue__1:                                  ; preds = %condTrue__1, %continue__3
  %35 = phi i1 [ %34, %condTrue__1 ], [ %33, %continue__3 ]
  br i1 %35, label %condTrue__2, label %condContinue__2
...
condContinue__2:                                  ; preds = %condTrue__2, %condContinue__1
  %result = phi i1 [ %36, %condTrue__2 ], [ %35, %condContinue__1 ]
...
condContinue__3:                                  ; preds = %condFalse__1, %condTrue__3
  %39 = phi %String* [ %37, %condTrue__3 ], [ %38, %condFalse__1 ]
  %40 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
...
condTrue__4:                                      ; preds = %condContinue__3
  %42 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  br label %condContinue__4

condFalse__2:                                     ; preds = %condContinue__3
  %43 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0))
  br label %condContinue__4

condContinue__4:                                  ; preds = %condFalse__2, %condTrue__4
  %44 = phi %String* [ %42, %condTrue__4 ], [ %43, %condFalse__2 ]
  %45 = call %String* @__quantum__rt__string_concatenate(%String* %41, %String* %44)
  ...
  %46 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @2, i32 0, i32 0))
...
condTrue__5:                                      ; preds = %condContinue__4
  %48 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  br label %condContinue__5

condFalse__3:                                     ; preds = %condContinue__4
  %49 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0))
  br label %condContinue__5

condContinue__5:                                  ; preds = %condFalse__3, %condTrue__5
  %50 = phi %String* [ %48, %condTrue__5 ], [ %49, %condFalse__3 ]
  %51 = call %String* @__quantum__rt__string_concatenate(%String* %47, %String* %50)
  ...
  %52 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @3, i32 0, i32 0))
...
condTrue__6:                                      ; preds = %condContinue__5
  %54 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @0, i32 0, i32 0))
  br label %condContinue__6

condFalse__4:                                     ; preds = %condContinue__5
  %55 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @1, i32 0, i32 0))
  br label %condContinue__6

condContinue__6:                                  ; preds = %condFalse__4, %condTrue__6
  %56 = phi %String* [ %54, %condTrue__6 ], [ %55, %condFalse__4 ]
  %57 = call %String* @__quantum__rt__string_concatenate(%String* %53, %String* %56)
  ...
  call void @__quantum__rt__message(%String* %57)
...
define internal void @Microsoft__Quantum__OracleGenerator___db80fb546e9242059ab5fcd88d8543b5_InitOracleGeneratorFor__body(%Callable* %func) {
entry:
