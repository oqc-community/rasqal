...
continue__3:                                      ; preds = %then0__3, %continue__2
  %29 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %a)
  %__qsVar0__first__ = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %29)
  %30 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %b)
  %__qsVar1__second__ = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %30)
  %31 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %c)
  %__qsVar2__third__ = call i1 @Microsoft__Quantum__Canon__IsResultOne__body(%Result* %31)
...
condContinue__3:                                  ; preds = %condFalse__3, %condTrue__3
  ...
  br i1 %__qsVar0__first__, label %condTrue__4, label %condFalse__4
...
condContinue__4:                                  ; preds = %condFalse__4, %condTrue__4
  ...
  br i1 %__qsVar1__second__, label %condTrue__5, label %condFalse__5
...
condContinue__5:                                  ; preds = %condFalse__5, %condTrue__5
  ...
  br i1 %__qsVar2__third__, label %condTrue__6, label %condFalse__6
