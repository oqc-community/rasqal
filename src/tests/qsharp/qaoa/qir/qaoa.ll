...
entry:
  ...
  call void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__body(%Callable* %6, %Array* %target)
  call void @__quantum__rt__array_update_alias_count(%Array* %target, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___9a13b462f1ec469bb799c3855ff18d8c_IndexRange__body(%Array* %register)
...
entry:
  ...
  call void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__adj(%Callable* %6, %Array* %target)
  call void @__quantum__rt__array_update_alias_count(%Array* %target, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %6, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %6, i32 -1)
  ret void
...
define internal void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
entry:
  ...
  call void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %11)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %target, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__ctl(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  ...
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
  %3 = call %Range @Microsoft__Quantum__Arrays___9a13b462f1ec469bb799c3855ff18d8c_IndexRange__body(%Array* %register)
...
entry:
  ...
  store %Callable* %9, %Callable** %12, align 8
  store %Array* %target, %Array** %13, align 8
  call void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %11)
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %target, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %9, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %9, i32 -1)
...
define internal void @Microsoft__Quantum__Canon___05be71904163434e9a024f437633cc52_ApplyToEachCA__ctladj(%Array* %__controlQubits__, { %Callable*, %Array* }* %0) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %__controlQubits__, i32 1)
  %1 = getelementptr inbounds { %Callable*, %Array* }, { %Callable*, %Array* }* %0, i32 0, i32 0
  %singleElementOperation = load %Callable*, %Callable** %1, align 8
...
entry:
  ...
  %0 = call %Array* @Microsoft__Quantum__Arrays___265c88f497e746b6b5be2c9f94536f00_Zipped__body(%Array* %weights, %Array* %target)
...
define internal %Array* @Microsoft__Quantum__Arrays___265c88f497e746b6b5be2c9f94536f00_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
entry:
  ...
  %0 = call %Array* @Microsoft__Quantum__Arrays___c7bf78098f324ae5a559afd35f016108_Zipped__body(%Array* %segmentCosts, %Array* %usedSegments)
  %1 = call i64 @__quantum__rt__array_get_size_1d(%Array* %0)
  %2 = sub i64 %1, 1
  br label %header__1
...
define internal %Array* @Microsoft__Quantum__Arrays___c7bf78098f324ae5a559afd35f016108_Zipped__body(%Array* %left, %Array* %right) {
entry:
  %output = alloca %Array*, align 8
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 1)
...
entry:
  ...
  %3 = call %Array* @Microsoft__Quantum__Arrays___8e02664a947244eabc9d05e2c2f24753_ConstantArray__body(i64 %1, double %2)
...
then0__1:                                         ; preds = %entry
  call void @Microsoft__Quantum__Diagnostics___6fde5e2d20ee41ff904dafbd2891e644___QsRef1__FormattedFailure____body(i64 %actual, i64 %expected, %String* %message)
...
define internal %Array* @Microsoft__Quantum__Arrays___8e02664a947244eabc9d05e2c2f24753_ConstantArray__body(i64 %length, double %value) {
entry:
...
exit__1:                                          ; preds = %header__1
  ...
  call void @Microsoft__Quantum__Canon___f1e23cefbbfd46eeacb83d9f0c240ea1_ApplyToEach__body(%Callable* %10, %Array* %x)
  %11 = call %Array* @Microsoft__Quantum__Arrays___b0dcca9eb7a549e48b9593ef40e9c4cc_Zipped__body(%Array* %timeZ, %Array* %timeX)
...
define internal void @Microsoft__Quantum__Canon___f1e23cefbbfd46eeacb83d9f0c240ea1_ApplyToEach__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___b0dcca9eb7a549e48b9593ef40e9c4cc_Zipped__body(%Array* %left, %Array* %right) {
entry:
  %output = alloca %Array*, align 8
  call void @__quantum__rt__array_update_alias_count(%Array* %left, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %right, i32 1)
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___12ed7f256a2f4cf385e4e895aa9fdd55_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___b45e251b517b4955a031ced603c1dbf4_ForEach__body(%Callable* %0, %Array* %targets)
  call void @__quantum__rt__array_update_alias_count(%Array* %targets, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
...
define internal void @Microsoft__Quantum__Diagnostics___6fde5e2d20ee41ff904dafbd2891e644___QsRef1__FormattedFailure____body(i64 %actual, i64 %expected, %String* %message) {
entry:
...
define internal %Array* @Microsoft__Quantum__Arrays___12ed7f256a2f4cf385e4e895aa9fdd55_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
...
define internal %Range @Microsoft__Quantum__Arrays___9a13b462f1ec469bb799c3855ff18d8c_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___b45e251b517b4955a031ced603c1dbf4_ForEach__body(%Callable* %action, %Array* %array) {
entry:
  %retval = alloca %Array*, align 8
